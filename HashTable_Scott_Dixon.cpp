...
//============================================================================
const unsigned int DEFAULT_SIZE = 300;
...
// FIXME (1): Initialize the structures 
...
void loadBids(string csvPath, HashTable* hashTable) {
    ...
    for (auto const& c : header) {
        cout << c << "  "; //Incorrect parsing of .txt
}
cout << "" << endl;
try {
...
while (choice != 9) {
    ...
    switch (choice) {
        case 1:
            ...
            cout << "time: " << ticks * 10.0 / CLOCKS_PER_SEC << " seconds" << endl;
        break;
        case 2:
            bidTable->PrintAll();
        break;
    ...
    cout << "time: " << ticks << " clock ticks" << endl;
    cout << "time: " << ticks * 10.0 / CLOCKS_PER_SEC << " seconds" << endl;
    cout << "Good bye, thank you for trying the Hash Table # 4.2 algorithm." << endl;
return 0;
}